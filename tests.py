...
class B16MessageEncryptionTests(unittest.TestCase, BaseTest):
    ...
    def test_encrypt(self):
        actual, _, _ = encrypt(TEST_MESSAGE, B16)
    ...
    def test_encrypt_keyed(self):
        actual, encryption_key, _ = encrypt(TEST_MESSAGE, B16, shuffle=True)
...
class B32MessageEncryptionTests(unittest.TestCase, BaseTest):
    def test_encrypt(self):
        actual, _, _ = encrypt(TEST_MESSAGE, B32)
    ...
    def test_encrypt_keyed(self):
        actual, encryption_key, _ = encrypt(TEST_MESSAGE, B32, shuffle=True)
    ...
    def test_decrypt(self):
        encrypted, _, _ = encrypt(TEST_MESSAGE, B32)
        decrypted = decrypt(bytes(encrypted, ENCODING), B32)
        self.assertEqual(TEST_MESSAGE.decode(ENCODING), decrypted)

    def test_decrypt_keyed(self):
        encrypted, encryption_key, _ = encrypt(TEST_MESSAGE, B32, shuffle=True)
        decrypted = decrypt(bytes(encrypted, ENCODING), B32, encryption_key)
        self.assertEqual(TEST_MESSAGE.decode(ENCODING), decrypted)

    def test_decrypt_offset(self):
        encrypted, encryption_key, offset = encrypt(TEST_MESSAGE, B32, offset_hexagrams=True)
        decrypted = decrypt(bytes(encrypted, ENCODING), B32, encryption_key, offset)
        self.assertEqual(TEST_MESSAGE.decode(ENCODING), decrypted)

    def test_decrypt_keyed_offset(self):
        encrypted, encryption_key, offset = encrypt(TEST_MESSAGE, B32, shuffle=True, offset_hexagrams=True)
        decrypted = decrypt(bytes(encrypted, ENCODING), B32, encryption_key, offset)
        self.assertEqual(TEST_MESSAGE.decode(ENCODING), decrypted)
...
class B64MessageEncryptionTests(unittest.TestCase, BaseTest):
    def test_encrypt(self):
        actual, _, _ = encrypt(TEST_MESSAGE, B64)
    ...
    def test_encrypt_keyed(self):
        actual, encryption_key, _ = encrypt(TEST_MESSAGE, B64, shuffle=True)
    ...
    def test_decrypt(self):
        encrypted, _, _ = encrypt(TEST_MESSAGE, B64)
        decrypted = decrypt(bytes(encrypted, ENCODING), B64)
        self.assertEqual(TEST_MESSAGE.decode(ENCODING), decrypted)

    def test_decrypt_keyed(self):
        encrypted, encryption_key, _ = encrypt(TEST_MESSAGE, B64, shuffle=True)
